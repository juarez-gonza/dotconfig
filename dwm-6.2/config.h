...
// Color palettes:
// 0. dwm default
// 1. color palette https://colorhunt.co/palette/161649
// 2. color palette https://colorhunt.co/palette/124440
...
static const Layout layouts[] = {
	...
	{ "><>",      NULL },    /* no layout function means floating beh */
	{ "[M]",      monocle },
};
...
static Key keys[] = {
	...
	{ MODKEY,			XK_Return, spawn,          {.v = maintermcmd } },
	{ Mod1Mask|ControlMask,		XK_t, spawn,          {.v = sectermcmd } },
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        spawn,          {.v = maintermcmd } },
